...
export function MultiSelect({ label, options, selectedOptions, onChange, errorMessage, hasError, clearError }: MultiSelectProps) {
  ...
  return (
    <div className="relative w-full">
      <Combobox multiple value={selectedOptions} onChange={(newSelectedOptions) => {
